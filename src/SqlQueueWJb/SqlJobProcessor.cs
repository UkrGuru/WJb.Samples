...
/// while delegating actual execution to base JobProcessor (0.25.0-beta).
/// </summary>
public class SqlJobProcessor(
    ...
    IDbService db
) : JobProcessor(queue, actionFactory, settingsRegistry, logger)
{
    ...
    /// updating DB status accordingly. Base JobProcessCoreAsync still handles
    /// Next-chaining & error boundaries.
    /// </summary>
